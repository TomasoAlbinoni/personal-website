  ...
  return (
    <>
      ...
      <div className="text-with-img">
        <div className="text">
          <p>I&apos;m Thomas van Nellen, a senior software developer with over a decade of experience building secure, maintainable software solutions &ndash; from backend systems and CRM integrations to app development with Unity. 
